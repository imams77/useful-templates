...
//    function determine_locale()
    ...
    /**
      ...
      * @param bool $escape_html Since 6.2.6 – return an escaped HTML safe version of the field value. Requires $format_value to be true. Defaults to false.
      * @return (mixed) if legacy multisite, false if not.
      */
    function get_sub_field(string $selector, [$format_value = true], [$escape_html=true])
    {
    }
}
